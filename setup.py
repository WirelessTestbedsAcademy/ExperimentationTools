...
setup(
    ...
    package_dir={
        ...
        'gnuplot_measurement_logger': 'measurement_logger/gnuplot_logger'},
    packages=['measurement_logger', 'mysql_measurement_logger', 'oml_measurement_logger', 'file_measurement_logger', 'stdout_measurement_logger','gnuplot_measurement_logger'],
    url='',
    license='',
